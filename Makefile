...
cppunit.tgz:
	curl -H "PRIVATE-TOKEN: ${CI_JOB_TOKEN}" https://gitlab.com/api/v4/groups/9386326/packages
	curl -H "PRIVATE-TOKEN: ${CI_JOB_TOKEN}" https://gitlab.com/api/v4/projects/22845459/packages/cppunit
	curl --fail -H "PRIVATE-TOKEN: ${CI_JOB_TOKEN}" https://gitlab.com/api/v4/projects/22845459/packages/cppunit/1.40.0/cppunit-linux-x86_64.tgz -o cppunit.tgz
