...
void PacketTest::testSerialize()
{
  ...
  assert_equal("a=1.2.3.4:567|e=ping|s=F|f=5.6.7.8:80|r=6719|t=1606953004|u=1606000000", p.serialize());
}
...
void PacketTest::testSerializeLeader()
{
  ...
  assert_equal("a=1.2.3.4:567|e=ping|s=L|f=1.2.3.4:567|r=6719|t=1606953004|u=1606000000|m=4.4.4.4:4444,5.5.5.5:5555", p.serialize());
}

void PacketTest::testParse()
{
  Packet p;
  assert_true(p.parse("a=1.2.3.4:567|e=ping|s=F|f=5.6.7.8:80|r=6719|t=1606953004|u=1606000000"));
...
{
  Packet p;
  assert_true(p.parse("a=1.2.3.4:567|e=ping|s=L|f=1.2.3.4:567|r=6719|t=1606953004|u=1606000000|m=4.4.4.4:4444,5.5.5.5:5555"));
  assert_equal(Packet::Ping, p.reason());
...
{
  Packet p("a=1.2.3.4:567|e=ping|s=L|f=1.2.3.4:567|r=6719|t=1606953004|u=1606000000|m=4.4.4.4:4444,5.5.5.5:5555");
  assert_equal(Packet::Ping, p.reason());
  assert_equal(Packet::Leading, p.state());
  assert_equal("1.2.3.4:567", p.self());
  assert_equal("1.2.3.4:567", p.following());
...
void PacketTest::testWho()
{
  ...
  assert_equal("a=|e=who|s=A|f=1.2.3.4:80|r=0|t=0|u=0", p.serialize());
}
